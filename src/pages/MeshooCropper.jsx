        ...
        <div className="bg-white shadow-xl rounded-2xl overflow-hidden transform transition-all duration-300">
          <div className="md:flex">
            ...
            <div className="md:w-2/3 p-8">
              <div className="flex justify-between items-center mb-8">
                <h1 className="text-3xl font-extrabold text-gray-900 flex items-center">
                  <span className="bg-pink-600 text-white rounded-xl p-2 mr-3">
                    M
                  </span>
              ...
              {processedFiles.length === 0 ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end space-x-4">
                    ...
                    <button
                      ...
                      className="px-6 py-3 rounded-full text-sm font-bold text-white bg-pink-600 hover:bg-pink-700 transition-colors disabled:opacity-50 flex items-center justify-center"
                    >
                      {isProcessing ? (
                        <svg
                ...
                >
                  ...
                  <div className="flex justify-end mt-6">
                    <button
                      onClick={handleReset}
                      className="px-6 py-3 rounded-full text-sm font-semibold text-white bg-pink-600 hover:bg-pink-700 transition-colors"
                    >
                      Process More Files
                    </button>
                  </div>
            ...
            <div className="md:w-1/3 p-8 bg-pink-400 text-white rounded-r-2xl shadow-inner">
              ...
              <div className="space-y-5">
                {Object.keys(settings).map((key) => (
                  ...
                  >
                    <label
                      htmlFor={key}
                      className="flex-1 text-sm font-medium capitalize select-none text-pink-100 group-hover:text-white transition-colors cursor-pointer"
                    >
                      {key.replace(/_/g, " ")}
                    </label>
                    <input
              ...
              <div className="mt-12 border-t border-pink-400 pt-6">
